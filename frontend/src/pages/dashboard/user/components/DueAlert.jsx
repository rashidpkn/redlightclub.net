    ...
    <div className="fixed top-0 left-0 z-50 h-screen w-full bg-black/30 flex justify-center items-center p-3">
      ...
      }
      {
        step === 2 && <div className="max-w-[1114px]  w-full p-5 flex flex-col justify-center items-center gap-5 text-black text-center rounded-xl bg-[#F5F5F5]">
          ...
          <p className='font-bold text-2xl'>Choose Profile</p>
      ...
      {
        step === 3 && <div className="max-w-[1114px] h-[545px] w-full p-5 flex flex-col  justify-between items-center gap-5 text-black text-center rounded-xl bg-[#F5F5F5]">
          <div className="flex justify-end w-full">
            <Close />
          </div>
          <div className="text-center ">
            <p className='font-bold text-2xl'>Choose Position</p>
            <p className='mt-5'>Choose Position to be displayed the profile on website <br /> Start Bidding to own more Position</p>
          ...
          <div className="flex justify-center items-center gap-10">
            <button className='font-bold text-sm' onClick={() => { setStep(2) }}>Back</button>
      ...
      {
        step === 4 && <div className="max-w-[1114px] h-[545px] w-full p-5 flex flex-col justify-between items-center gap-5 text-black text-center rounded-xl bg-[#F5F5F5]">
          <div className="flex justify-end w-full">
            <Close/>
          </div>
          <p className='font-bold text-2xl'>Choose Confirm</p>
          ...
          <div className="flex justify-center items-center gap-10">
          <button className='font-bold text-sm' onClick={() => { setStep(3) }}>Back</button>
