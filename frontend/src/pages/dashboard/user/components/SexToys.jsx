  ...
  return (
    <div className='space-y-5'>
        ...
        <div className="flex flex-wrap gap-3">
            <div className="w-[717px]  h-[300px]"><img src={sexToy1} className='w-full h-full rounded-xl' alt="" /> </div>
            <div className="w-[360px]  h-[300px]"><img src={sexToy2} className='w-full h-full rounded-xl' alt="" /> </div>
            <div className="w-[1092px] h-[300px]"><img src={sexToy3} className='w-full h-full rounded-xl' alt="" /> </div>
        </div>
    </div>
  )
}
