        ...
        <div className="space-y-1">
            ...
            <div className="flex  items-center">
                ...
                <div className="flex items-center gap-5 w-max p-2 rounded-xl bg-[#F6EEFF]">
                    <input placeholder='Enter username' type="text" className='w-80 h-11 outline-[#6418C3] outline-1 bg-[#F5F5F5] text-sm rounded-xl pl-5' onChange={e=>dispatch(setSocialMedia({type:'onlyFans',value:e.target.value}))} value={onlyFans} />
