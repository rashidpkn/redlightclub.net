...
function Rate({ currencyType, inCall, outCall, phone }) {
  return (
    <div className="rate space-y-3 text-white">
      ...
      <div className=" flex justify-center gap-3">
        <div className="incall   w-[630px] space-y-3  ">
          ...
          <div className="w-full h-14 bg-white/20 flex justify-between items-center px-8">
          ...
          <div className="w-full h-14  flex justify-between items-center px-8">
