...
function ProfileDetails({ adsTitle, updatedAt, service, age, height, weight, hair, eye, phone, email, socialMedia }) {
    return (
        <div className='profile-details space-y-3 text-white w-[630px]'>
            <div className="w-full h-20 bg-[red] flex justify-between items-center px-8">
                <p className="text-xl font-bold capitalize">{adsTitle}</p>
                <p>{updatedAt}</p>
            </div>
            <div className="services p-8 w-full space-y-3">
            ...
            <div className="contact w-full flex flex-wrap justify-between items-center px-8">
